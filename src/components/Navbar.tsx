    ...
    <nav className="sticky top-0 z-50 border-b border-border/40 bg-obsidian/90 backdrop-blur-xl">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-3.5">
        ...
        <div className="hidden items-center gap-8 md:flex">
          ...
          <a href="https://app.holygiraffe.com/login" className="font-heading text-sm font-medium text-muted-foreground transition-colors duration-200 hover:text-gold">Log in</a>
          <BrutalButton onClick={() => window.location.href = "https://app.holygiraffe.com/login"}>Get Early Access</BrutalButton>
        </div>
      ...
      {open && (
        <div className="border-t border-border/30 bg-obsidian md:hidden animate-[fadeUp_0.2s_ease-out]">
          <div className="flex flex-col gap-4 px-5 py-5">
            ...
            <a
              href="https://app.holygiraffe.com/login"
              className="font-heading text-sm font-medium text-muted-foreground hover:text-gold"
              onClick={() => setOpen(false)}
            >
              Log in
